...
public class ManagerClient extends Thread{
	 ...
	 */
	public ManagerClient(int testMode, String badgeID, String recordID,
	...
	public static void main(String[] args) {
		try{
			...
			while(true){
				...
				switch(userChoice){
					case 1:
						new ManagerClient(userChoice, "SPVM1111", "","JOHN", "DILINGER", "MURDER", "CAPTURED","","","","");
						new ManagerClient(userChoice, "SPVM1112", "","JOHN", "DILINGER", "MURDER", "CAPTURED","","","","");
						new ManagerClient(userChoice, "SPVM1113", "","JOHN", "DILINGER", "MURDER", "CAPTURED","","","","");
						break;
					case 2:
						new ManagerClient(userChoice, "SPVM1111", "","FERNANDO", "SUCRE", "", "FOUND","01/01/2009","QUEBEC","QUEBEC","");
						new ManagerClient(userChoice, "SPL1111", "","THEODARE", "BAGWELL", "", "MISSING","01/01/2009","QUEBEC","QUEBEC","");
					...
					case 4:	
						...
						new ManagerClient(userChoice, "SPL1111", "MR11111","", "BAGWELL", "", "MISSING","","","","");
						new ManagerClient(userChoice, "SPB1111", "MR11111","", "DARIK", "", "FOUND","","","","");
						break;
					case 5:
						new ManagerClient(userChoice, "SPVM1111", "CR11111", "", "", "", "", "", "", "","spl");
						break;
					case 6:
						new ManagerClient(userChoice, "SPVM2222", "","JOHN", "DILINGER", "MURDER", "CAPTURED","","","","");
						new ManagerClient(userChoice, "SPL2222", "","JAMES", "WHISTLER", "MURDER", "ONTHERUN","","","","");
						new ManagerClient(userChoice, "SPB2222", "","JOY", "DON", "MURDER", "CAPTURED","","","","");
						new ManagerClient(userChoice, "SPVM3333", "","ROBERT", "POLE", "", "MISSING","12/12/2011","MONTREAL","MAISONNEUVE","");
						new ManagerClient(userChoice, "SPL3333", "","FERNANDO", "SUCRE", "", "MISSING","01/01/2009","QUEBEC","QUEBEC","");
						new ManagerClient(userChoice, "SPB3333", "","MICHAEL", "SCOFIELD", "", "FOUND","12/02/2011","TORONTO","TORONTO","");
						new ManagerClient(userChoice, "SPVM4444", "","", "", "", "","","","","");
						new ManagerClient(userChoice, "SPL4444", "","", "", "", "","","","","");
						new ManagerClient(userChoice, "SPB4444", "","", "", "", "","","","","");
						new ManagerClient(userChoice, "SPVM5555", "CR11112","", "DILINGER", "", "ONTHERUN","","","","");
						new ManagerClient(userChoice, "SPL5555", "MR11112","", "SUCRE", "", "FOUND","","","","");
						new ManagerClient(userChoice, "SPB5555", "MR11112","", "SCOFIELD", "", "MISSING","","","","");
						new ManagerClient(userChoice, "SPL6666", "CR11111","", "", "", "","","","","SPVM");
						break;
					default:
