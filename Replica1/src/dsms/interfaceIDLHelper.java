...
public class interfaceIDLHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, dsms.interfaceIDL t)
    {
     ...
     */
    public static dsms.interfaceIDL extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return dsms.interfaceIDLHelper.narrow( a.extract_Object() );
        }
    ...
    private final static String _id = "IDL:dsms/interfaceIDL:1.0";
     ...
     */
    public static dsms.interfaceIDL read(org.omg.CORBA.portable.InputStream istream)
    {
        return(dsms.interfaceIDL)istream.read_Object(dsms._interfaceIDLStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, dsms.interfaceIDL value)
    {
