...
public class MulticastMessageSender {
    ...
    /**
     * Multi casts the operation to other replicas
     *
     * @param msg
     * @return
     */
    ...
    /**
     * Receives the output from other replicas
     *
     * @param soc
     * @return
     */
    ...
    /**
     * Multi casts request to other replicas
     *
     * @param request
     * @param port
     * @return
    ...
    /**
     * Gets responses of request from multiple replicas
     *
     * @param soc
     * @return
     */
    ...
    /**
     * Deserializes the Message object from input
     *
     * @param inPacket
     * @return
     * @throws IOException
