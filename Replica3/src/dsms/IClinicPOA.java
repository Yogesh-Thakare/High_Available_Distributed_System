 ...
 */
public abstract class IClinicPOA extends org.omg.PortableServer.Servant
        implements IClinicOperations, org.omg.CORBA.portable.InvokeHandler
{
    public IClinic _this()
    {
        return IClinicHelper.narrow(_this_object());
    }

    public IClinic _this(org.omg.CORBA.ORB orb)
    {
        return IClinicHelper.narrow(_this_object(orb));
    }
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getRecordCounts(
        ...
        String _arg_result = getRecordCounts(arg0_in, arg1_in);
