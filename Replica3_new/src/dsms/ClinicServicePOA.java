...
public abstract class ClinicServicePOA extends org.omg.PortableServer.Servant
        implements ClinicServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
    public ClinicService _this()
    {
        return ClinicServiceHelper.narrow(_this_object());
    }

    public ClinicService _this(org.omg.CORBA.ORB orb)
    {
        return ClinicServiceHelper.narrow(_this_object(orb));
    }
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_createNRecord(
        ...
        String _arg_result = createNRecord(arg0_in, arg1_in, arg2_in, arg3_in, arg4_in);
