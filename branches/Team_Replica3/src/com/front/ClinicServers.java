...
public class ClinicServers{
	...
	public static void main(String args[]) throws InvalidName, ServantAlreadyActive, WrongPolicy, ObjectNotActive, AdapterInactive, IOException{
			...
			ClinicServerImpl spvmObj = new ClinicServerImpl(Constants.MTL_UDP_PORT);
			ClinicServerImpl splObj = new ClinicServerImpl(Constants.LVL_UDP_PORT);
			ClinicServerImpl spbObj = new ClinicServerImpl(Constants.DDO_UDP_PORT);
